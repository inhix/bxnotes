...
Геттер и сеттер, работают с `this` аналогично, как и вызов функции из ключа объекта. Их `this` будет указывать на контекст объекта, в котором происходит их вызов.
